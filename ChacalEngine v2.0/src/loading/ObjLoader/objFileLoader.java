...
public class objFileLoader {
	    ...
	    public static RawModel loadOBJ(String objFileName, Loader loader) {
	        ...
	        try {
	            while (true) {
	                ...
	                if (line.startsWith("v ")) {
	                    ...
	                    Vector3f vertex = new Vector3f((float) Float.valueOf(currentLine[currentLine.length-3]),
	                            (float) Float.valueOf(currentLine[currentLine.length-2]), (float) Float.valueOf(currentLine[currentLine.length-1]));
	            ...
	            while (line != null && line.startsWith("f ")) {
	                ...
	                if(currentLine.length>=5){
						...
						processVertex(vertex4, vertices, indices);
	        ...
	        RawModel model= loader.loadToVOA(verticesArray, texturesArray, normalsArray, indicesArray);
