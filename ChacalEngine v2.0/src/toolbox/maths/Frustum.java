...
public class Frustum {
	...
	public static Frustum getFrustum(Matrix4f view,Matrix4f projec) {
		Matrix4f v = Maths.createViewMatrixParams(Pipeline.camera.getPosition().getMul(1).getOglVec(),Pipeline.camera.getPitch(),Pipeline.camera.getYaw(),0);
		frustum.calculateFrustum(v, projec);
		return frustum;
	}
	...
	private void calculateFrustum(Matrix4f view,Matrix4f projec) {
		this._proj.clear();
		this._modl.clear();
		this._clip.clear();
