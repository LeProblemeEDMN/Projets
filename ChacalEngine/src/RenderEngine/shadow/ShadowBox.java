...
public class ShadowBox {
	...
	public static final float SHADOW_DISTANCE = 80;
	...
	protected void update() {
		...
		Vector3f centerNear = Vector3f.add(toNear, cam.getPosition().getOglVec(), null);
		Vector3f centerFar = Vector3f.add(toFar, cam.getPosition().getOglVec(), null);
