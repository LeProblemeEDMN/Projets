...
public class Fbo {
	...
	public static final int POS_BUFFER = 2;
	...
	private void initialiseFrameBuffer(int type) {
		...
		if(multisample) {
			...
			colourBuffer3 =createMultiSampleColourAttachment(GL30.GL_COLOR_ATTACHMENT1);
		}else {
			if(type == POS_BUFFER) {
				createTextureAttachmentPos();
			}else
	...
	private void createTextureAttachmentPos() {
		colourTexture = GL11.glGenTextures();
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, colourTexture);
		GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGB16, width, height, 0, GL11.GL_RGB, GL11.GL_FLOAT,
				(ByteBuffer) null);
